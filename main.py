...
def main(dataset, evaluation, cluster):
    datafile = ['movie', 'SBU-3DFE', 'SJAFFE', 'Yeast-alpha', 'Yeast-cdc', 'Yeast-cold', 'Yeast-diau', 'Yeast-dtt',
    ...
    Alpha = {'movie':0.60, 'SBU-3DFE':0.70, 'SJAFFE':0.70, 'Yeast-alpha':0.89, 'Yeast-cdc':0.89, 'Yeast-cold':0.89, 'Yeast-diau':0.85, 'Yeast-dtt':0.92,
                'Yeast-elu':0.89, 'Yeast-heat':0.88, 'Yeast-spo':0.83, 'Yeast-spo5':0.81, 'Yeast-spoem':0.82}
    # K = [66, 13, 5, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24]
    K = {'movie':66, 'SBU-3DFE':13, 'SJAFFE':5, 'Yeast-alpha':24, 'Yeast-cdc':24, 'Yeast-cold':24, 'Yeast-diau':24, 'Yeast-dtt':24,
    ...
    for i in range(n_clusters):
        members = kLabels == i
        LPA.fit(X[members], labels[members], alpha=Alpha[dataset])
...
if __name__ == '__main__':
    ...
    main(dataset, evaluation, cluster)